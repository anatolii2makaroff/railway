...
if __name__ == '__main__':
    ...
    for e in edges:
        ...
        g.add_edge(e["data"]["source"], e["data"]["target"], distance)

        # print("{} -> {} = {}".format(e["data"]["source"], e["data"]["target"], distance))


    print("Count of nodes: {}".format(cnt))

    dijkstra(g, g.get_vertex('8220'))

    target = g.get_vertex('8221')
    path = [target.get_id()]
